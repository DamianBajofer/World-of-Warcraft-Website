...
<body>
	<!-- Forum -->
	<div id='page'>
		<?php include($_SERVER["DOCUMENT_ROOT"]."/forums/php/views/newthread.php"); ?>
	</div>
	<!-- Sonidos y Efectos -->
	<audio id='success' style='display:none;' src='<?php echo $__DIR; ?>/forums/sounds/success.wav'></audio>
	<audio id='failed' style='display:none;' src='<?php echo $__DIR; ?>/forums/sounds/failed.wav'></audio>
</body>
</html>